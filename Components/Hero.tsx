        ...
        <div className='heroContainer'>
          ...
          <div className="Suboverlay"></div>
            ...
            <div className="heroMessageContent">
              ...
              <h1 className="heroMessageEn1">Shintoku Kaiun pursues visionary shipowner</h1>
              <h1 className="heroMessageEn2">while keeping the traditional aspects of the shipowner.</h1>
              </motion.div>
              <motion.p 
                              variants={{
                                offscreen: { // 画面外の場合のスタイル
              ...
              <h1 className="heroMessageJp1">進徳海運は昔ながらの船主像を踏襲しつつ、</h1>
              <h1 className="heroMessageJp2">来るべき船主像を探求いたします。</h1>
              </motion.div>
            </div>
          </div>
